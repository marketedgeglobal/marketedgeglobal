  ...
  return (
    <section className="mx-auto max-w-6xl px-6 py-20">
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <section id="laos-news" className="rounded-3xl border border-[var(--color-card-border)] bg-gradient-to-b from-[var(--color-card-gradient-top)] to-[var(--color-card-gradient-bottom)] p-8 min-h-[120px]">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-3">
            <h3 className="text-lg font-semibold text-[var(--color-heading)]">Laos News</h3>
            <a
          ...
          <div className="space-y-2 text-sm text-[var(--color-body)]">
            <div><span className="font-medium text-[var(--color-heading)]">What it does:</span> Track Laos market signals and news intelligence.</div>
            <div><span className="font-medium text-[var(--color-heading)]">Typical inputs:</span> Country focus, sector priorities, news timeframe.</div>
            <div><span className="font-medium text-[var(--color-heading)]">Typical outputs:</span> News digest, market signal summaries, emerging risks.</div>
          </div>
        </section>

        <section id="sea-leaders" className="rounded-3xl border border-[var(--color-card-border)] bg-gradient-to-b from-[var(--color-card-gradient-top)] to-[var(--color-card-gradient-bottom)] p-8 min-h-[120px]">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-3">
            <h3 className="text-lg font-semibold text-[var(--color-heading)]">SEA Leaders</h3>
            <a
          ...
          <div className="space-y-2 text-sm text-[var(--color-body)]">
            <div><span className="font-medium text-[var(--color-heading)]">What it does:</span> Track Southeast Asia leadership signals and news intelligence.</div>
            <div><span className="font-medium text-[var(--color-heading)]">Typical inputs:</span> Regional focus, leadership priorities, news timeframe.</div>
            <div><span className="font-medium text-[var(--color-heading)]">Typical outputs:</span> Leadership digest, regional signal summaries, emerging risks.</div>
          </div>
        </section>
